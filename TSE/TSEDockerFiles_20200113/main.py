...
try:
    ...
    to_num = input_json['variables_to_numeric']
    ...
    ctrl_var = input_json['control_var']
    ...
    if dist_plot == True:
        if ctrl_var == False:
            ...
            logger.error("Please give one variable name or False.")
            sys.exit("Execution interrupted!")
    ...
    if task != False: 
        ...
        kFold = input_json['k_fold/split_ratio']
